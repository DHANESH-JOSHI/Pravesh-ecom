...
exports.getAllCarts = (0, utils_1.asyncHandler)(async (req, res) => {
    ...
    if (cachedResult) {
        res.status(http_status_1.default.OK).json(new ApiResponse(http_status_1.default.OK, 'Carts retrieved successfully', cachedResult));
        return;
    }
    const filter = {};
    if (user) {
    ...
    res.status(http_status_1.default.OK).json(new ApiResponse(http_status_1.default.OK, 'Carts retrieved successfully', result));
    return;
});
